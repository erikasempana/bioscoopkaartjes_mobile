...
export const getAllMovie = params => {
  return {
    type: 'GET_ALL_MOVIE',
    payload: axios.get(
      `movie/?limit=4&page=${params.page}&sort=${params.sort}&sortBy=${params.sortBy}&searchRelease=${params.releaseDate}&searchName=${params.searchName}`,
    ),
